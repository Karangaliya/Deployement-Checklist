        ...
        <div className="w-full  min-h-screen py-5 px-10 bg-slate-300 pt-[125px] flex flex-col gap-6  text-black">
            ...
            <div className="px-5 bg-white shadow-xl py-3 flex justify-between item-center rounded-2xl ">
                ...
                <div className="w-[40%] flex justify-end items-center gap-5">
                    <div className="text-xl"><FaPencilAlt/></div>
                    <div className="text-xl"><FaRegTrashAlt /></div>
                    <div className="text-xl" onClick={()=>setPriority(!priority)}>{!priority ? <GoStar /> : <GoStarFill/>}</div>
                </div>
            </div>
